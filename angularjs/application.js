...
(function() {
  ...
  var dependencies = [
    ...
    'wuMasonry',
    'modules',
    'angularjs/controllers/messengerController',
    'angularjs/controllers/navbarContoller',
    'angularjs/controllers/avatarModalController',
    'angularjs/controllers/avatarController',
    'angularjs/controllers/loginController',
    'angularjs/controllers/fileController',
    'angularjs/controllers/activityController',
    'angularjs/controllers/activityItemController',
  ...
  define( dependencies, function(
    ...
    messengerController,
    navbarContoller,
    avatarModalController,
    avatarController,
    LoginCtrl,
    fileController,
    activityController,
    activityItemController
  ) {
